    ...
    <div className="footer" ref={footerRef}>
      <div className="footer-row">
        ...
        <div className="footer-ctas">
          <a href="#" onClick={(e) => { e.preventDefault(); navigator.clipboard.writeText(person.email); alert("Email copied to clipboard!"); }} className="footer-cta-pill">
          ...
          <a href={linkedinUrl} target="_blank" rel="noreferrer" className="footer-cta-icon footer-tooltip" data-tooltip="LinkedIn">
            <Linkedin size={24} />
          </a>
        </div>
      </div>
