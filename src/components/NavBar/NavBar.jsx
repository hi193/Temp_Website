...
import { Briefcase, DownloadSimple, User, Envelope, LinkedinLogo, Phone, PawPrint } from "@phosphor-icons/react";
      ...
      <header className="header-nav" ref={menuRef}>
        <div className="header-inner">
          <div className="header-left">
            ...
            }} className="nav-logo" aria-label="Home" style={{ display: 'flex', alignItems: 'center', color: '#fff' }}>
